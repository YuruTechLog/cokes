...
**目的:** Approach AxisをCokes体系の中で正しく使うための運用ルールと、Cokes/Axisの責任分担を示す。

## 骨子

- **Cokes/Axis関係図の掲載**
  Cokes（上位体系）
    └─ Approach Axis（人間とAIのIFで出力方向を扱う操作体系）
  役割分担: Axis=人間軸レンジ×AIベクトル場の操作体系 / Cokes=工程・知識・責任・委任条件を整理する上位体系。
  （参照: `axis-log-03/integrated_knowledge.md` §IK02・§IK03）
